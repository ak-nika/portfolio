  ...
  return (
    <section className="mt-[10px] py-20 px-5 md:py-[100px] md:px-8 lg:px-10 flex flex-col md:flex-col-reverse lg:flex-row">
      ...
      <div className="lg:pl-10">
        <div className="flex justify-start md:justify-center lg:justify-start mt-8">
          <Chip>About</Chip>
        </div>
        ...
        <p className="paragraph text-left md:text-center lg:text-left mt-6 text-grey">
          With a foundation in problem-solving and creativity, I now channel my
          expertise into software development, merging aesthetics,
